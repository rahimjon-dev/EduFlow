      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:max-w-md">
          ...
          <p className="text-sm text-slate-500 mb-8">
            Please sign in to access your educational dashboard.
          </p>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div>
                  <p className={`text-sm font-semibold ${selectedRole === 'ADMIN' ? 'text-indigo-900' : 'text-slate-700'}`}>Admin</p>
              ...
              >
                ...
                <div>
                  <p className={`text-sm font-semibold ${selectedRole === 'TEACHER' ? 'text-emerald-900' : 'text-slate-700'}`}>Teacher</p>
              ...
              >
                ...
                <div>
                  <p className={`text-sm font-semibold ${selectedRole === 'STUDENT' ? 'text-sky-900' : 'text-slate-700'}`}>Student</p>
              ...
              >
                ...
                <div>
                  <p className={`text-sm font-semibold ${selectedRole === 'PARENT' ? 'text-purple-900' : 'text-slate-700'}`}>Parent</p>

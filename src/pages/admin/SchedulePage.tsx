      ...
      >
        ...
        <div className="space-y-1 text-xs text-slate-700">
          ...
          <div className="flex items-center gap-1.5 text-[11px] text-slate-600">
            ...
            <span>Cohort: {session.groupName}</span>
          </div>
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Classroom section schedules, faculty assignments, and lab timeslots."
        actions={
      ...
      {loading ? (
        <LoadingState message="Generating timetable matrix..." />
      ) : viewMode === 'weekly' ? (
        /* Weekly Grid View */
            ...
            return (
              <div key={day} className="flex flex-col bg-slate-50/70 rounded-2xl border border-slate-200/80 p-3 min-h-[400px]">
                <div className="flex items-center justify-between pb-3 border-b border-slate-200/70 mb-3 px-1">
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-800">{day}</span>

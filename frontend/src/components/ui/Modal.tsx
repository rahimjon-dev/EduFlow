...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto p-4 sm:p-6 animate-in fade-in duration-200">
      ...
      <div
        className={cn(
          'relative w-full bg-slate-900/40 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 overflow-hidden transform transition-all z-10',
      ...
      >
        ...
        {/* Footer */}
        {footer && (
          <div className="flex items-center justify-end gap-3 px-5 sm:px-6 py-4 bg-white/5 border-t border-white/10">
            {footer}
          </div>
        )}
      </div>
